        ...
        <div className="flex-1 flex gap-8 items-center justify-end">
          ...
          <div className="flex gap-5 items-center">
            <div className="w-[150px]">
              <p className="font-semibold">{curAdminLogin.user_name}</p>
              <p className="text-sm  text-slate-500">{curAdminLogin.address}</p>
            </div>
            <div className="flex items-center">
              <img src={curAdminLogin.avata} className="size-14 rounded-full" />
